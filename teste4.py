...
if pagamento.lower() == 'sim':
    chave_pix = input("Por favor, digite a chave de PIX ou link para pagamento: ")
    # Insira aqui o código para efetuar o pagamento via PIX utilizando a chave_pix ou o link
    print(f"Pagamento via PIX efetuado com sucesso para a chave/link {chave_pix}!")
else:
